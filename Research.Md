...
- *Suitability of index insurance: new insights from satellite data. With David Lobell*. [working paper](https://github.com/MatthieuStigler/MatthieuStigler.github.io/blob/master/docs/cropIns_paper_latest.pdf)
